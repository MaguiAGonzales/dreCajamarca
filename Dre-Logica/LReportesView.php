<?php
	...
	$query = "SELECT * FROM boleta inner join usuario on boleta.dni_usuario = usuario.dni_usuario ORDER BY id_boleta ASC";
	 ...
	 if(isset($_POST["buscar"])){
	 	...
	 	$query = "SELECT * FROM boleta inner join usuario on boleta.dni_usuario = usuario.dni_usuario where numeroBo like '%$descripcion%' and concat(usuario.nomb_usu,' ',usuario.ap_pusu,' ',usuario.ap_musu) like  '%$nombre%'
